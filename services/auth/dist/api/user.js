...
function default_1(app) {
    ...
    app.get('/users/:id', (0, middlewares_1.validateRequest)(schemas_1.userSchema.getUser), (req, res) => __awaiter(this, void 0, void 0, function* () {
        const id = req.params.id;
        const user = yield services_1.userService.getUserById(id);
        res.status(200).json({ message: '', data: user, success: true });
    }));
    app.put('/users/:id', (0, middlewares_1.validateRequest)(schemas_1.userSchema.getUser), (req, res) => __awaiter(this, void 0, void 0, function* () { }));
}
